# Decompiled By Matin 1879
import urllib2, sys, threading, random, re, sys, os, hashlib, requests, sys, os

def banner():
    print ' \x1b[34;1m\n\n\n:::   ::: :::   :::      :::    :::     :::     ::::    ::::      :::          :::   ::: :::   ::: \n:+:   :+: :+:   :+:      :+:    :+:   :+: :+:   +:+:+: :+:+:+   :+: :+:        :+:   :+: :+:   :+: \n +:+ +:+   +:+ +:+       +:+    +:+  +:+   +:+  +:+ +:+:+ +:+  +:+   +:+        +:+ +:+   +:+ +:+  \n  +#++:     +#++:        +#++:++#++ +#++:++#++: +#+  +:+  +#+ +#++:++#++:        +#++:     +#++:   \n   +#+       +#+         +#+    +#+ +#+     +#+ +#+       +#+ +#+     +#+         +#+       +#+    \n   #+#       #+#         #+#    #+# #+#     #+# #+#       #+# #+#     #+#         #+#       #+#    \n   ###       ###         ###    ### ###     ### ###       ### ###     ###         ###       ###    \n\n   Yy Hama Yy Powerful DDOS Attack Tool // Yy Hama Yy (Attack Boy) // Telegram : @iiyiyiyi \n\n\n\n>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> ATTACK HAS BEEN STARTED <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<\n\n\n\n\t\t'
...
def usage():
    print '####################################################'
    print '#     How to use : python2 attackboy.py <url>      #'
    print '#  github : yyhamayy & Telegram : @iiyiyiyi        #'
    print '####################################################'
...
def httpcall(url):
    ...
    try:
        ...
        set_flag(1)
        print '\x1b[31;1m Yy Hama Yy DDOS ATTACKED'
        code = 500
...
def chk():
  ...
  try:
    HAMA = requests.get("https://github.com/yyhamayy/IDACTIVE.txt/blob/main/IDACTIVE.txt").text
    if id in HAMA :
